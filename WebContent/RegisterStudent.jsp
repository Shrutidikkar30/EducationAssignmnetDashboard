...
<html lang="en" dir="ltr">
  <head>
   <meta charset="UTF-8">
	...
	<script type="text/javascript" src="RegisterFact.js"></script>
...
<body>
  ...
  <div class="container">
    ...
    <div class="content">
      <form action="RegisterStudController" method="post" onsubmit="return validate(this)">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your username" name="username" maxlength="10" required>
          ...
          <div class="input-box">
            ...
            <input type="number" placeholder="Enter your Enrollment Number" name="eno" required>
            <span style="color:red" id="enrollErr"></span>
          </div>  
          <%
          	HttpSession hs=request.getSession();
          	if(!hs.isNew()) {
          	Object o=session.getAttribute("rolerror");
          	out.println("<h4 style=color:red>Enrollment already exists</h4>");
          	}
          	hs.invalidate();
          	%>
          <div class="input-box">
