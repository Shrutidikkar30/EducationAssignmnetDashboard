	...
	<div class="container infinity-container">
		<div class="row">
			...
			<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 text-center infinity-form">
				...
				<!-- Form -->
				<form action="LoginFactController" method="post"  class="px-3">
					<!-- Input Box -->
					<div class="form-input">
						<span><i class="fa fa-user"></i></span>
						<input type="text" name="factuname" placeholder="Username" required>
						<span style="color: red" id="unameErr"></span>
						
					</div>
					<div class="form-input">
						<span><i class="fa fa-lock"></i></span>
						<input type="password" name="factpass" placeholder="Password" required>
					...
					<div class="row mb-3">
			   	    ...
			   	    <div class="text-right ">
		                <a href="resetFact.jsp" class="forget-link">Forgot password?</a>
		            </div>
			   	    <!-- Login Button -->
		            <div class="mb-3"> 
					...
					<div class="text-center mb-5" style="color: #777;">Don't have an account? 
						<a class="" href="RegisterFaculty.jsp">Register here</a>
			       	</div>
				</form>
			</div>
			<!-- FORM END -->
